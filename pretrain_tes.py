...
parser.add_argument('--ckpt', default='./ckpts/bert-base-p40-const/checkpoint-20000-v3')
...
if __name__ == '__main__':
    ...
    # print(f'Memorization {np.mean(acces)} +- {np.std(acces)} :{np.mean(acces): .2f}({np.std(acces): .2f})')
    # print(f'ACC {np.mean(acces)} +- {np.std(acces)} :{np.mean(acces): .2f}({np.std(acces): .2f})')
    # print(f'Loss {np.mean(losses)} +- {np.std(losses)} :{np.mean(losses): .2f}({np.std(losses): .2f})')
    # print(f'Entropy {np.mean(entropies)} +- {np.std(entropies)}:{np.mean(entropies): .2f}({np.std(entropies): .2f})')
    # print(f'RankMe:emb {np.mean(rankme_embs)} +- {np.std(rankme_embs)} :{np.mean(rankme_embs): .2f}({np.std(rankme_embs): .2f})')
    # print(f'RankMe:repre {np.mean(rankme_repreps)} +- {np.std(rankme_repreps)} :{np.mean(rankme_repreps): .2f}({np.std(rankme_repreps): .2f})')
